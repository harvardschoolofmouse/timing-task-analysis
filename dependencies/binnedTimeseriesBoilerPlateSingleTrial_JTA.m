...
fLick(obj.GLM.rewardedTrials) = find(obj.GLM.pos.juice(1:end-1) - obj.GLM.pos.juice(2:end)<0);
% iii = ones(size(obj.GLM.cue_s));
% iii(trialsIncluded) = 0;
% fLick(logical(iii)) = nan;
